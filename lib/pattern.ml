...
let all_steps = function
  ...
  | NNpsk0 -> [[PSK; E]; [E; EE]]
  | NNpsk2 -> [[E]; [E; EE; PSK]]
  | NKpsk0 -> [[PSK; E; ES]; [E; EE]]
  | NKpsk2 -> [[E; ES]; [E; EE; PSK]]
  | NXpsk2 -> [[E]; [E; EE; S; ES; PSK]]
  | KNpsk0 -> [[PSK; E]; [E; EE; SE]]
  | KNpsk2 -> [[E]; [E; EE; SE; PSK]]
  | KKpsk0 -> [[PSK; E; ES; SS]; [E; EE; SE]]
  | KKpsk2 -> [[E; ES; SS]; [E; EE; SE; PSK]]
  | KXpsk2 -> [[E]; [E; EE; SE; S; ES; PSK]]
  | INpsk1 -> [[E; S; PSK]; [E; EE; SE]]
  | INpsk2 -> [[E; S]; [E; EE; SE; PSK]]
  | IXpsk2 -> [[E; S]; [E; EE; SE; S; ES; PSK]]
  | XNpsk3 -> [[E]; [E; EE]; [S; SE; PSK]]
  | XKpsk3 -> [[E; ES]; [E; EE]; [S; SE; PSK]]
